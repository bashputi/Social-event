...
const Navbar = () => {
    ...
    return (
        ...
        <div className="navbar-start">
            ...
            <a className="btn btn-ghost normal-case text-xl"><span className="text-amber-600 text-2xl font-bold">Wedding</span><span className="text-green-700 text-2xl font-bold">Planner</span> </a>
        </div>
        ...
        <div className="navbar-end">
            {
                user ? <>
                    ...
                    <a onClick={logOut} className="btn btn-sm text-2xl font-bold">Log out</a>
                </> 
                : <Link to="/login">
                    <button className="btn btn-sm btn-ghost text-xl font-bold">Login</button>
                </Link>
            }
